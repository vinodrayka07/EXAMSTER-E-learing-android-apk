...
public class CollageAdapter extends RecyclerView.Adapter<CollageAdapter.MovieHolder> {

    private final Context context;
    private final List<Movie> movieList;

    public CollageAdapter(Context context , List<Movie> movies){
    ...
    public void onBindViewHolder(@NonNull MovieHolder holder, int position) {
        ...
        holder.constraintLayout.setOnClickListener(v -> {
           ...
           branchFragment branchFragment =new branchFragment();
            activity.getSupportFragmentManager().beginTransaction().replace(R.id.frame,branchFragment).addToBackStack(null).commit();
