...
public class branchAdapter extends RecyclerView.Adapter<branchAdapter.MovieHolder> {

    private final Context context;
    private final List<Movie> movieList;

    public branchAdapter(Context context , List<Movie> movies){
    ...
    public void onBindViewHolder(@NonNull MovieHolder holder, int position) {
        ...
        holder.constraintLayout.setOnClickListener(v -> {
            ...
            activity.getSupportFragmentManager().beginTransaction().replace(R.id.frame,yearFragment).addToBackStack(null).commit();
