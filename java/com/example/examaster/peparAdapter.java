...
public class peparAdapter extends RecyclerView.Adapter<peparAdapter.MovieHolder> {

    private final Context context;
    private final List<Movie> movieList;


    public peparAdapter(Context context , List<Movie> movies){
    ...
    public void onBindViewHolder(@NonNull MovieHolder holder, int position) {
        ...
        holder.constraintLayout.setOnClickListener(v -> {
            Intent intent = new Intent(context ,downloadActivity2.class);
            ...
            //activity.getSupportFragmentManager().beginTransaction().replace(R.id.frame,downloadFragment).addToBackStack(null).commit();
