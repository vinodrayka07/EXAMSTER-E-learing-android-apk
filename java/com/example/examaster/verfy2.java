...
public class verfy2 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        String url = getIntent().getStringExtra("otherurl");
                                ...
                                .addOnCompleteListener(new OnCompleteListener<AuthResult>() {
                                    ...
                                    public void onComplete(@NonNull Task<AuthResult> task) {
                                        ...
                                        if (task.isSuccessful()) {
                                            ...
                                            Toast.makeText(verfy2.this, "Enter the correct Otp", Toast.LENGTH_SHORT).show();
                                        }
                                    }
                                });

                    } else {
                        Toast.makeText(verfy2.this, "Please check internet connection", Toast.LENGTH_SHORT).show();
                    }

//                    Toast.makeText(verifyenterotptwo.this,"otp verify",Toast.LENGTH_SHORT).show();
                } else {
                    Toast.makeText(verfy2.this, "please enter all number", Toast.LENGTH_SHORT).show();
                }
            }
        });
                ...
                PhoneAuthProvider.getInstance().verifyPhoneNumber(
                        ...
                        new PhoneAuthProvider.OnVerificationStateChangedCallbacks() {
                            ...
                            public void onVerificationFailed(@NonNull FirebaseException e) {
                                ...
                                Toast.makeText(verfy2.this, e.getMessage(), Toast.LENGTH_SHORT).show();
                            }
                            ...
                            public void onCodeSent(@NonNull String newbackendotp, @NonNull PhoneAuthProvider.ForceResendingToken forceResendingToken) {
                                ...
                                Toast.makeText(verfy2.this, "Otp sended Succussfully", Toast.LENGTH_SHORT).show();
                            }
                        }
                );
            }
